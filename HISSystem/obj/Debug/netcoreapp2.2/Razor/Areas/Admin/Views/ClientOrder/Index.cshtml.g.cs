#pragma checksum "E:\GeneticGit\GeneticGit\genetic_system\HISSystem\Areas\Admin\Views\ClientOrder\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "41fb9b96429beeb968f97209188cd3e7586dde97"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"41fb9b96429beeb968f97209188cd3e7586dde97", @"/Areas/Admin/Views/ClientOrder/Index.cshtml")]
...
");
    ...
    <script>
        ...
        function updateOrderData() {
            var formdata = ne");
                WriteLiteral(@"w FormData($('form').get(0));
        ...
        function addOrderData() {
            ListHtml = document.getElementById('orderAre");
        ...
        function test() {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $(""#clientOrder_ClientOrder_User_RegisterationNo"").val(data.re");
                WriteLiteral(@"gisterationNo);
   ...
   ");
                WriteLiteral(@"     function dynamicAdmissionFields() {
        ...
        $(docu");
                WriteLiteral(@"ment).on(""change"", ""#AppointmentID"", function () {
            dynamicAdmissionFields();
        });
        ...
        function fnExcelReport() {
            ...
            if (msie > 0 || !!navigator.userAgent.match(/Trident.*rv\:11\./))      // If Internet Explorer
            {
                ...
                txtArea1.document.writ");
                WriteLiteral(@"e(tab_text);
