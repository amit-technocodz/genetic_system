#pragma checksum "J:\GitHub\genetic_system\HISSystem\Areas\Admin\Views\PatientOrder\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "019d551f0c1a561ccef1d2695731f7e69e1574a5"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"019d551f0c1a561ccef1d2695731f7e69e1574a5", @"/Areas/Admin/Views/PatientOrder/Index.cshtml")]
    public class Areas_Admin_Views_PatientOrder_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<Data.Helpers.PagedData<Data.Models.PatientOrder>>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            WriteLiteral("\r\n");
            EndContext();
#line 3 "J:\GitHub\genetic_system\HISSystem\Areas\Admin\Views\PatientOrder\Index.cshtml"
...
#line 84 "J:\GitHub\genetic_system\HISSystem\Areas\Admin\Views\PatientOrder\Index.cshtml"
...
");
            EndContext();
#line 177 "J:\GitHub\genetic_system\HISSystem\Areas\Admin\Views\PatientOrder\Index.cshtml"
...
");
                ...
                if (TypeID == 66 || TypeID == 63) {
                    ...
                    if (AppointmentID != 0 && AppointmentID != null) {
                        $.ajax({
                            ...
                            type: 'POST',
                            data: { AppointmentID: Appo");
                WriteLiteral(@"intmentID },
                ...
                success: function (data) {
                    if (data.length > 0) {
                        if (data[0].buildingID) {
                            var markup = ""<opti");
                WriteLiteral(@"on value='0'>Select Floor</option>"";
                            var selectRoom = ""<option value='0'>Select Room</option>"";
                            var selectBed = ""<option value='0'>Select Bed</option>"";
                            if (data.length > 0) {
                                $.each(data, function (val, text) {
                        ...
                        if (data[0].floorID) {
                            ...
                            $.each(data, function (val, text) {
                                markup += ""<option value="" + text.id + "">"" + text.name + ""</opti");
                WriteLiteral(@"on>"";
                            });
            ...
            if (AppointmentID != 0 || AppointmentID != null) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $(""#PatientAdmission_SpecialityID"").val(data.spe");
                WriteLiteral(@"cialityID);
   ...
   ");
        ...
        function fnExcelReport() {
            ...
            va");
                WriteLiteral(@"r msie = ua.indexOf(""MSIE "");
