#pragma checksum "E:\GeneticSystem Unified\GC 21.2.20 J\GeneticSystem\HISSystem\Areas\Admin\Views\DynamicTemplate\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "cca37e4c238de4c0c233e62fadf33ac3262f44a9"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"cca37e4c238de4c0c233e62fadf33ac3262f44a9", @"/Areas/Admin/Views/DynamicTemplate/Index.cshtml")]
    public class Areas_Admin_Views_DynamicTemplate_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<List<Data.Models.Template>>
    {
        ...
        {
#line 2 "E:\GeneticSystem Unified\GC 21.2.20 J\GeneticSystem\HISSystem\Areas\Admin\Views\DynamicTemplate\Index.cshtml"
...
<div class=""prtm-content");
    ...
    <div class=""prtm-page-bar"">
        ...
        <div class=""row"">
            ...
            <div class=""col-md-5"">
                <label for=""search"">&nbsp;</label> <br /><a href=""#"" data-info=""addMasterLookup"" class=""btn btn-xs btn-warning addMasterLookup""><i class=""fa fa-plus"" aria-hidden");
            WriteLiteral(@"=""true""></i> Add Master Template</a>
            </div>
        </div>
    </div>
...
");
            EndContext();
#line 90 "E:\GeneticSystem Unified\GC 21.2.20 J\GeneticSystem\HISSystem\Areas\Admin\Views\DynamicTemplate\Index.cshtml"
...
#line hidden
            ...
            EndContext();
            BeginWriteAttribute("onclick", " onclick=\"", 3123, "\"", 3164, 3);
            WriteAttributeValue("", 3133, "GetTemplateDetail(this,\'", 3133, 24, true);
#line 92 "E:\GeneticSystem Unified\GC 21.2.20 J\GeneticSystem\HISSystem\Areas\Admin\Views\DynamicTemplate\Index.cshtml"
WriteAttributeValue("", 3157, item, 3157, 5, false);
...
#line hidden
            ...
            WriteLiteral("</a></h4>\r\n");
            EndContext();
#line 93 "E:\GeneticSystem Unified\GC 21.2.20 J\GeneticSystem\HISSystem\Areas\Admin\Views\DynamicTemplate\Index.cshtml"
                                        }

#line default
#line hidden
            BeginContext(3225, 1803, true);
            WriteLiteral(@"                                    </div>
                                </div>
                            </div>
                        </div>
...
");
    ...
    <script>
        ...
        function editTemplateData(event) {
            ...
            var multiSelect = targ");
                WriteLiteral(@"etElement.parentElement.getElementsByClassName('tryMultiselect');
        ...
        function disableTemplateData(event) {
            ...
            var elements = targetElement.parentElem");
                WriteLiteral(@"ent.getElementsByClassName('itemDatadsbl');
        ...
        function updateTemplateData(event) {
            ...
            formdata.append(""TemplateData.TemplateID"", formRow.getAttribute(""data-info""));
              ...
              ");
                WriteLiteral(@"    var fields = $(this).find("":input"");
        ...
        function hideTemplateData(event) {
            event.target.parentElement.parentElement.hidden = tr");
                WriteLiteral(@"ue;
        }
     ...
     ");
                WriteLiteral(@"       var TemplateID = $(this).data('info');
            debugger
        ...
        $(document).on(""click"", """);
                WriteLiteral(@".addTemplateDetail"", function () {
            //debugger
       ...
       ");
                WriteLiteral(@"              GetTemplateDetail(values);
        ...
        $(function () {
            $(""#addLookUp"").on('submit', function (e) {
                ...
                $.pos");
                WriteLiteral(@"t(""/admin/lookup/add"", dataToPost)
        ...
        $(document).ready(function () {
            $(""body"").on(""click"", '.page-number', function () {
                ...
                $.ajax({
             ");
                WriteLiteral(@"       url: '/admin/lookup/_getlookupindex',
                    context: $(this),
        ...
        function getFloors() {
            ...
            var url = '");
                EndContext();
                BeginContext(21137, 17, false);
#line 542 "E:\GeneticSystem Unified\GC 21.2.20 J\GeneticSystem\HISSystem\Areas\Admin\Views\DynamicTemplate\Index.cshtml"
                  Write(Url.Content("~/"));

#line default
#line hidden
                EndContext();
                BeginContext(21154, 5428, true);
        ...
        va");
                WriteLiteral(@"r x = 1; //counter for appending formRows (global variable)
        ...
        function updateTemplateCol() {
            ...
            $.ajax({
                type: ""POST"",
                u");
                WriteLiteral(@"rl: '/admin/dynamictemplate/UpdateTemplate',
                data: formdata,
                processData: false,
                contentType: false,
                success: function (data) {
        ...
        $(document).on(""click"", "".backToTemplate"", function () {
            ...
            $(""#DataLookup"").find('.tryMultiselect').each(function (i, element) {
   ");
                WriteLiteral(@"             $(element).chosen('destroy');
                $(element).chosen();
                var removeTemp = element.parentElement.getElementsByClassName('chosen-container');
                removeTemp[1].remove();
            });
