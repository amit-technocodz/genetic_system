#pragma checksum "E:\GeneticGit\GeneticGit\genetic_system\HISSystem\Areas\Admin\Views\Patient\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "ffd82e569bea448b1b95a345225729a5e6448462"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"ffd82e569bea448b1b95a345225729a5e6448462", @"/Areas/Admin/Views/Patient/Index.cshtml")]
    public class Areas_Admin_Views_Patient_Index : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<dynamic>
    {
        #pragma warning disable 1998
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
#line 1 "E:\GeneticGit\GeneticGit\genetic_system\HISSystem\Areas\Admin\Views\Patient\Index.cshtml"
...
#line 81 "E:\GeneticGit\GeneticGit\genetic_system\HISSystem\Areas\Admin\Views\Patient\Index.cshtml"
...
");
            ...
            WriteLiteral(@"
                                ...
                                <div class=""col-md-2 col-lg-2"">
                                    ...
                                    ");
            EndContext();
            BeginContext(7973, 162, false);
#line 172 "E:\GeneticGit\GeneticGit\genetic_system\HISSystem\Areas\Admin\Views\Patient\Index.cshtml"
...
");
            EndContext();
#line 185 "E:\GeneticGit\GeneticGit\genetic_system\HISSystem\Areas\Admin\Views\Patient\Index.cshtml"
...
");
    ...
    <script>
        ...
        function patientSearch() {
            ...
            $.ajax({
          ");
                WriteLiteral(@"      url: '/admin/patient/SearchPatient',
                type: 'POST',
                data: model,
            ...
            if (TypeID != null) {
                if (TypeID == 66 || TypeID == 63) {
                    ...
                    if (AppointmentID != 0 && AppointmentID != null) {
                        $.ajax({
                            url: '/admin/patient/G");
                WriteLiteral(@"etAppointmentReservedBy',
                            type: 'POST',
...
");
        ...
        function GetType(event) {
            ...
            if (id == 'AdmissionTypeID') {
                url = url + 'FillType");
                WriteLiteral(@"DropDown?id=' + event.value;
            }
            $.ajax({
                url: url,
                type: 'GET',
     ...
     ");
                WriteLiteral(@"               if (data.length > 0) {
                        ...
                        ");
                WriteLiteral(@"    $.each(data, function (val, text) {
                                markup += ""<option value="" + text.id + "">"" + text.name + ""</option>"";
                            });
        ...
        $(document).on(""change"", ""#PatientAdmission_OutPatientTypeID"", ");
            ...
            if (AppointmentID != 0 || AppointmentID != null) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        debugger
            ");
                WriteLiteral(@"            $(""#PatientAdmission_DepartmentID"").val(data.departmentID);
        ...
        function fnExcelReport() {
            ...
            tab_tex");
                WriteLiteral(@"t = tab_text.replace(/<input[^>]*>|<\/input>/gi, """"); // reomves input params
