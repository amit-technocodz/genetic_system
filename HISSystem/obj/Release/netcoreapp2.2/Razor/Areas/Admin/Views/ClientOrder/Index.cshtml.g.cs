#pragma checksum "E:\GeneticSystem Unified\GC 21.2.20 J\GeneticSystem\HISSystem\Areas\Admin\Views\ClientOrder\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7951622512fb73db3b1c081b7faa03554c019fcb"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7951622512fb73db3b1c081b7faa03554c019fcb", @"/Areas/Admin/Views/ClientOrder/Index.cshtml")]
                ...
                success: function (data) {
                    if (data.length > 0) {
                        if (data[0].buildingID) {
                            var markup = ""<option v");
                WriteLiteral(@"alue='0'>Select Floor</option>"";
                            var selectRoom = ""<option value='0'>Select Room</option>"";
                            var selectBed = ""<option value='0'>Select Bed</option>"";
                            if (data.length > 0) {
                                $.each(data, function (val, text) {
            ...
            if (AppointmentID != 0 || AppointmentID != null) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $(""#PatientAdmission_SpecialityID"").val(data.special");
                WriteLiteral(@"ityID);
